# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 16:19:45 2024
...
features = ['DayOfWeek', 'Month', 'Distance', 'TimePeriod', 'ArrTime']
...
model = xgb.XGBClassifier(objective='binary:logistic', random_state=42)  # For classification
